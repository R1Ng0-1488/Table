...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-+4bk0#id#-9oiid_j$fcusd0^zgk)-ot)p(*%zg6-rykq*l*^&')
...
CORS_ORIGIN_WHITELIST = os.environ.get('CORS', 'http://localhost:8080').split(' ')
